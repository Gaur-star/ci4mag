  ...
  <div class="container-fluid">
    <form action="<?php echo base_url() ?>/admin/settings/settings_edit_process" method="post" class="newsletter_form" enctype='multipart/form-data'>
      ...
      if (isset($_SESSION['st_vdata'])) {
        echo "<div class='my-3 mx-2 text-center'>" . $_SESSION['st_vdata'] . "</div>";
      ...
      <div class="row">
          ...
          <div class="col-6"><a href="<?php echo base_url(); ?>/sitemap.xml" target="_blank">https://w2ci.inewsguru.com/sitemap.xml</a></div>
      </div>
      <div class="form-group">
        <div class="row">
      ...
      <div class="form-group row">
        <div class="col-2"><span class="input-title">Site Address</span></div>
        <div class="col-6"> <input type="text" value="<?php echo $setting[13]["setting_value"]; ?>" class="form-control" required="required" name="<?php echo $setting[13]["id"]; ?>" id="email" style="width:100%;"></div>
      </div>
      <div class="form-group row">
        <div class="col-2"><span class="input-title">Site Phone</span></div>
        <div class="col-6"> <input type="text" value="<?php echo $setting[14]["setting_value"]; ?>" class="form-control" required="required" name="<?php echo $setting[14]["id"]; ?>" id="email" style="width:100%;"></div>
      </div>
      <div class="form-group row">
