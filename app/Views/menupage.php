                ...
                <div class="col-md-4">
                    ...
                    <ul class="menupages">
                        ...
                        <li style="display: flex;">
                            <div class="col-md-6">
                                <input type="hidden" name="menu_id" id="menu_id" value="<?= $current ?>">
                        ...
                        <li>
                            <div class="btn btn-info btn-block" id="add_link"> Add Link</div>
                        </li>
...
<script>
    $(document).ready(function() {
		...
		if(label == '' || link == ''){
		    ...
		    $.ajax('<?= base_url('admin/admin/submitlink') ?>', {
		        type: 'POST',
		        data: { id: id, label: label,link: link },
		        success: function (data) {
		            window.location.href = "<?= base_url('admin/admin/menupage?m=') ?>"+id;
		        },
		    });
		}
	})
