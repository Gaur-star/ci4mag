    ...
    <form action="<?php echo base_url() ?>/admin/adsence/adsence_update" method="post" class="newsletter_form" >
      <?php
        if (isset($_SESSION['st_vdata'])) {
          echo "<div class='my-2 text-center'>" . $_SESSION['st_vdata'] . "</div>";
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-6"> <input type="text" value="header" class="form-control" name="" style="width:100%;" disabled></div>
      ...
      <div class="form-group row">
        <div class="col-2"><span class="input-title">Ad Position</span></div>
        <div class="col-6">
          <input type="text" placeholder="Enter Meta tag" name="" class="form-control" value="sidebar" disabled>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-2"><span class="input-title">Description</span></div>
