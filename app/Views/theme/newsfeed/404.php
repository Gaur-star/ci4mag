                  ...
                  foreach($single['post_tags'] as $categorie) { ?>
                    ...
                    <!-- <ul class="author_listing"> -->
                      ...
                      <!-- <figure class="single_post_img">
                        <img src="<//?= base_url('assets/newtheme/images/banner1.jpeg'); ?>" alt="" class="img-fluid">
                      </figure> -->
                      <div class="single_post_content">
                        <p>   <div class="error_page">
                            <h3>We Are Sorry</h3>
                            <h1>404</h1>
                            ...
                            <span></span> <a href="<?php echo base_url() ?>" class="wow fadeInLeftBig animated" style="visibility: visible; animation-name: fadeInLeftBig;">Go to home page</a> </div>
                        </div></p>
                      ...
                      <div class="post-navigation">
                        <div class="post_item">
                        <!-- </?php if(!empty($prePost['seo_url'])) { ?>
                            <a href="</?= base_url(). '/'. $prePost['seo_url'];?>">
                        ...
                        <div class="post_item align-right">
                          <!-- </?php if(!empty($nextPost['seo_url'])) { ?>
                            <a href="</?php if($nextPost['seo_url']){ echo base_url(). '/'. $nextPost['seo_url'];}?>">
                      ...
                      <!-- <div class="author_area">
                        <div class="author_info">
                          <div class="author_img"><img src="</?= base_url('assets/newtheme/images/gadget4.jpeg'); ?>" alt=""></div>
                      ...
                      <div class="row">
                        ...
                        <!-- <div class="col-sm-12">                          -->
                          <!-- <div class="related_slider owl-carousel"> -->
                            <!--  </?php if (isset($relatedPostRandom)) { foreach ($relatedPostRandom as $let) {  
                                if( $let["title"] != $single["title"] ){?> -->
                            <!-- <div class="latest_news_column">                               -->
                              <!-- <div class="latest_news_item">                                 -->
                                <!-- <a href="</?php echo base_url() ."/". $let["seo_url"]; ?>" class="latest_news_img" title=""><img src="</?php if(!empty($let["url"])) { echo $let["url"]; }else{ echo base_url().'/'.$settings[12]["setting_value"]; } ?>" alt=""></a>
                                <a href="</?php echo base_url().'/'.$let['seo_url'];?>" class="latest_news_title" title=""></?php echo $let['title'];?></a> -->
                                <!-- <ul class="author_listing"> -->
                                  <!-- <li> -->
                                    <!-- <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                                    <span></?= date("d M, Y", strtotime($let['date'])) ?></span> -->
                                  <!-- </li> -->
                                <!-- </ul> -->
                            ...
                            <!-- <div class="latest_news_column"> -->
                              <!-- <div class="latest_news_item">
                                <a href="</?= base_url().'/'. $relatedPostRandom[1]['seo_url'] ?>" class="latest_news_img"><img src="</?= $relatedPostRandom[1]['url'] ?>" alt=""></a>
                                <a href="</?= base_url().'/'. $relatedPostRandom[1]['seo_url'] ?>" class="latest_news_title"></?= $relatedPostRandom[1]['title'] ?></a>
                                <ul class="author_listing">
                                  <li>
                                    <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                                    <span></?= date("d M, Y", strtotime($relatedPostRandom[1]['date'])) ?></span>
                                  </li>
                                </ul> -->
                            ...
                            <!-- <div class="latest_news_column"> -->
                              <!-- <div class="latest_news_item">
                                <a href="</?= base_url().'/'. $relatedPostRandom[2]['seo_url'] ?>" class="latest_news_img"><img src="</?= $relatedPostRandom[2]['url'] ?>" alt=""></a>
                                <a href="</?= base_url().'/'. $relatedPostRandom[2]['seo_url'] ?>" class="latest_news_title"></?= $relatedPostRandom[2]['title'] ?></a>
                                <ul class="author_listing">
                                  <li>
                                    <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                                    <span></?= date("d M, Y", strtotime($relatedPostRandom[2]['date'])) ?></span>
                                  </li>
                                </ul> -->
                                <!-- <a href="" class="post_cat">gadget</a> -->
                              <!-- </div> -->
                            ...
                            <!-- <div class="latest_news_column"> -->
                             <!-- <div class="latest_news_item">
                                <a href="</?= base_url().'/'. $relatedPostRandom[3]['seo_url'] ?>" class="latest_news_img"><img src="</?= $relatedPostRandom[3]['url'] ?>" alt=""></a>
                                <a href="</?= base_url().'/'. $relatedPostRandom[3]['seo_url'] ?>" class="latest_news_title"></?= $relatedPostRandom[3]['title'] ?></a>
                                <ul class="author_listing">
                                  <li>
                                    <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                                    <span></?= date("d M, Y", strtotime($relatedPostRandom[3]['date'])) ?></span>
                                  </li>
                                </ul> -->
                                <!-- <a href="" class="post_cat">gadget</a> -->
                              <!-- </div>
                          ...
                          <ul class="comments_listing">
                            <li>
                              <div class="commment_item">
                                <div class="comment_img"><img src="</?= base_url('assets/newtheme/images/gadget4.jpeg'); ?>" alt=""></div>
                              ...
                              <div class="commment_item reply_comment">
                                <div class="comment_img"><img src="</?= base_url('assets/newtheme/images/ad-banner.png'); ?>" alt=""></div>
                                <div class="comment_info">
                                  <div class="comment_title"><b>Miss Lisa Doe</b> <span>15 Jan, 2022</span></div>
                                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam rem architecto pariatur aperiam molestias, quisquam explicabo doloremque a consequuntur repudiandae eligendi excepturi labore ea aspernatur iusto tempore? Tempore, assumenda qui!</p>
                                  <button class="btn reply_btn"><i class="fa-solid fa-share"></i> reply</button>
                            ...
                            <li>
                              <div class="commment_item">
                                <div class="comment_img"><img src="</?= base_url('assets/newtheme/images/banner1.jpeg'); ?>" alt=""></div>
                                <div class="comment_info">
                                  <div class="comment_title"><b>Miss Lisa Doe</b> <span>15 Jan, 2022</span></div>
                                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam rem architecto pariatur aperiam molestias, quisquam explicabo doloremque a consequuntur repudiandae eligendi excepturi labore ea aspernatur iusto tempore? Tempore, assumenda qui!</p>
                                  <button class="btn reply_btn"><i class="fa-solid fa-share"></i> reply</button>
                              ...
                              <div class="commment_item reply_comment">
                                <div class="comment_img"><img src="</?= base_url('assets/newtheme/images/banner2.jpeg'); ?>" alt=""></div>
                                <div class="comment_info">
                                  <div class="comment_title"><b>Miss Lisa Doe</b> <span>15 Jan, 2022</span></div>
                                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam rem architecto pariatur aperiam molestias, quisquam explicabo doloremque a consequuntur repudiandae eligendi excepturi labore ea aspernatur iusto tempore? Tempore, assumenda qui!</p>
                                  <button class="btn reply_btn"><i class="fa-solid fa-share"></i> reply</button>
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="popular_area">
                    <div class="thumb_medium_post">
                      <a href="<?= base_url().'/'. $latest_news[0]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $latest_news[0]['url']; ?>" alt="" class="img-fluid"></a>
                    ...
                    <ul class="thumb_listing">
                      <li>
                          <a href="<?= base_url().'/'. $latest_news[1]['seo_url']; ?>" class="thumb_img"><img src="<?= $latest_news[1]['url']; ?>" alt=""></a>
                      ...
                      <li>
                        <a href="<?= base_url().'/'. $latest_news[2]['seo_url']; ?>" class="thumb_img"><img src="<?= $latest_news[2]['url']; ?>" alt=""></a>
                        <div class="thumb_content">
                    ...
                    <li>
                      <a href="<?= base_url().'/'. $latest_news[3]['seo_url']; ?>" class="thumb_img"><img src="<?= $latest_news[3]['url']; ?>" alt=""></a>
                      <div class="thumb_content">
                  ...
                  <li>
                    <a href="<?= base_url().'/'. $latest_news[4]['seo_url']; ?>" class="thumb_img"><img src="<?= $latest_news[4]['url']; ?>" alt=""></a>
                    <div class="thumb_content">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-832px, 0px, 0px); transition: all 0s ease 0s; width: 2496px;"><div class="owl-item cloned" style="width: 416px;"><div class="trending_item">
                      ...
                      <div class="thumb_medium_post">
                        <a href="<?= base_url() . '/' . $trending[1]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $trending[1]['url'];?>" alt="" class="img-fluid"></a>
                        <div class="thumb_medium_post_overley">
                      ...
                      <div class="thumb_medium_post">
                        <a href="<?= base_url() . '/' . $trending[2]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $trending[2]['url'];?>" alt="" class="img-fluid"></a>
                        <div class="thumb_medium_post_overley">
                          <a href="" class="post_cat"><?= $trending[2]['categorie'] ?></a>
                          <a href="<?= base_url() . '/' . $trending[2]['seo_url']; ?>" class="thumb_medium_post_title"><?= $trending[2]['title']; ?></a>
                          <ul class="author_listing">
                            <!-- <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-user"></i></div>
                              <a href="">John Wick</a>
                            ...
                            <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                              <span> <?= date("d M, Y", strtotime($trending[2]['date_']));?></span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="thumb_medium_post">
                        <a href="<?= base_url() . '/' . $trending[3]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $trending[3]['url'];?>" alt="" class="img-fluid"></a>
                        <div class="thumb_medium_post_overley">
                          <a href="" class="post_cat"><?= $trending[3]['categorie'] ?></a>
                          <a href="<?= base_url() . '/' . $trending[3]['seo_url']; ?>" class="thumb_medium_post_title"><?= $trending[3]['title']; ?></a>
                          <ul class="author_listing">
                            <!-- <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-user"></i></div>
                              <a href="">John Wick</a>
                            ...
                            <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                              <span><?= date("d M, Y", strtotime($trending[3]['date_']));?></span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="thumb_medium_post">
                        <a href="<?= base_url() . '/' . $trending[4]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $trending[4]['url'];?>" alt="" class="img-fluid"></a>
                        <div class="thumb_medium_post_overley">
                          <a href="" class="post_cat"><?= $trending[4]['categorie'] ?></a>
                          <a href="<?= base_url() . '/' . $trending[4]['seo_url']; ?>" class="thumb_medium_post_title"><?= $trending[4]['title']; ?></a>
                          <ul class="author_listing">
                            <!-- <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-user"></i></div>
                              <a href="">John Wick</a>
                            ...
                            <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                              <span><?= date("d M, Y", strtotime($trending[4]['date_']));?></span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="thumb_medium_post">
                        <a href="<?= base_url() . '/' . $trending[5]['seo_url']; ?>" class="thumb_medium_img"><img src="<?= $trending[5]['url'];?>" alt="" class="img-fluid"></a>
                        <div class="thumb_medium_post_overley">
                          <a href="" class="post_cat"><?= $trending[5]['categorie'] ?></a>
                          <a href="<?= base_url() . '/' . $trending[5]['seo_url']; ?>" class="thumb_medium_post_title"><?= $trending[5]['title']; ?></a>
                          <ul class="author_listing">
                            <!-- <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-user"></i></div>
                              <a href="">John Wick</a>
                            ...
                            <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                              <span> <?= date("d M, Y", strtotime($trending[5]['date_']));?></span>
                            </li>
                          </ul>
                        </div>
                      </div>
