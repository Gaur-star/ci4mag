              ...
              <div class="col-md-8">
                ...
                <div class="col-12">
                  ...
                  <?php foreach ($id as $max_id) {    ?>
                    <input type="hidden" name="id" id="id" class="newsletter_input" placeholder="Enter your post title" value="<?= $max_id['max_id']; ?>" onkeyup="myFunction()">
                  <?php } ?>
                  <input type="hidden" id='last_id' name='last_id' value="<?= isset($_SESSION['last_id']) ? $_SESSION['last_id'] : ''; ?>">
                  <input type="hidden" id="preview_id" name="preview_id" value="<?= isset($_SESSION['preview_id']) ? $_SESSION['preview_id'] : ''; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class=" form-control" required placeholder="Enter your post title" value="<?php if (isset($data_value['value']['title'])) {
                                                                                                                                            echo $data_value['value']['title'];
                                                                                                                                          } ?>">
                    <input type="hidden" id="actionInput" value="" name="action">
                  </div>

                  <div class="form-group" style="<?= isset($post_data['sugest_title']) ? "block" : 'none'; ?>" id="s_title">
                    ...
                    <input type="text" name="sugest_title" id="sugest_title" class="newsletter_input form-control" required placeholder="Url" value="<?php if (!empty($data_value['value']['seo_url'])) {
                                                                                                                                                        echo $data_value['value']['seo_url'];
                                                                                                                                                      } ?> ">
                ...
                <div class="mb-2">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        <?php if ($roleId) { ?>
                          ...
                          <select name="author" id="author" class="form-control">
                            <option value="<?= $roleId ?>"><?= $u_firstname ?></option>
                            <?php foreach (get_author() as $author) { ?>
                              <option value="<?= $author['uid']; ?>" <?= isset($post_data['author']) ? "selected" : "" ?>><!-- &nbsp; --><?= $author['f_name'] . " " . $author['l_name']; ?>
                              </option>
                            <?php } ?>
                      ...
                      <div class="row">
                        <div class="col-4">
                          <button id="preview-btn" class="btn btn-sm btn-primary btn-block" type="button" onclick="pre_view('<?php print_r($id[0]['max_id']); ?>')">
                            Preview
                          </button>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                          <button class="btn btn-sm btn-primary btn-block" id="save_draft" onclick="draft_post('<?php print_r($id[0]['max_id']); ?>')">
                            Draft
                          </button>
                        </div>
                      </div>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <label class="form-group" id="preview" style="height:250px;width:100%; overflow:hidden;">
                        <!-- onclick="addImage()"  -->
                        <img id="preview_img" src="<?= base_url() . "/assets/admin-image/noimage.png" ?>" onclick="addImage()" class="img-thumbnail" style="width:100%;height: 250px;cursor: pointer;">
                ...
                <div class="mb-2">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <button class="btn btn-sm btn-primary mt-2"><a href="<?= base_url() . '/admin/category' ?>" style="color:white;">Categories</a></button>
                    </div>
                      ...
                      <ul class="catagory-list" id="catagorycheckbox">
                        ...
                        ?>
                          <li>
                            ...
                            <input type="checkbox" id="<?= $catdata['id'] ?>" class="catagory-checkbox" name="cat[]" id="cat[]" value="<?= $catdata['id'] ?>" data-id="" onclick="catagoryCheckbox()" data-name="<?= $catdata['categorie'] ?>" <?php
                ...
                <div class="mb-2">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      ?>
                      <input type="hidden" name="keyword_list" id="keyword_list" value="<?= isset($post_data['keyword_list']) ? $post_data['keyword_list'] : "" ?>">
                      <div class="editable">
                        <div id="tag_list">
                          <?php
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Meta tag" name="meta_tag" id="meta_tag" class="form-control" value="<?php if (!empty($data_value['value']['meta_tag'])) {
                                                                                                                                    echo $data_value['value']['meta_tag'];
                                                                                                                                  } ?>">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="Enter Meta description" name="meta_desc" id="meta_desc" rows="5" value="<?php if (!empty($data_value['value']['meta_desc'])) {
                                                                                                                                              echo $data_value['value']['meta_desc'];
                                                                                                                                            } ?>"><?= isset($post_data['meta_desc']) ? $post_data['meta_desc'] : "" ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-content" id="gallery-content">
              ...
              <div id="image-upload" class="tab-pane container">
                <div id="img-upload-section" class="row">
                  <div class="col-12">
                    <form id="media-upload" action="<?= base_url() ?>/admin/admin/imageUpload" enctype="multipart/form-data">
                      <div class="form-group">
...
<script>
  ...
  function pre_view($id) {
    ...
    if ((title.length == 0)) {
      ...
      $.ajax({
        url: '<?= base_url(); ?>/admin/admin/post_add_preview/' + $id,
        type: 'post',
        data: {
          content: content,
          date: date,
        ...
        success: function(data) {
          window.open('<?= base_url(); ?>/post_preview/' + date + '/' + seo_url + '/' + $id, '_blank');
  ...
  window.addEventListener('load', function() {
    intervalID = setInterval(myFun, 4000);
  });
  ...
  function myFun() {
    ...
    $.ajax({
      ...
      data: {
        ...
        seo_url: seo_url,
        content: source,
        last_dreaft_id: last_dreaft_id,
        visibility: visibility,
        date_: date_,
        time_: time_,
        update_date: update_date,
        nofollow: nofollow,
        seo_url_no: seo_url_no,
        post_parent: post_parent,
        seo_url_text: seo_url_text,
        image: image,
        cat: cat_id,
...
<script>
  $(document).ready(function() {
    ...
    CKEDITOR.replace('content', {
      ...
      filebrowserUploadUrl: '<?= base_url(); ?>/admin/home/upload_ck',
      filebrowserBrowseUrl: '<?= base_url(); ?>/home/upload_ck_file_browser',
