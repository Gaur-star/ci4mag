                      ...
                      <div class="panel">
                        ...
                        <div class="panel-body">
                          ...
                          <label for="image" style="width:100%; overflow:hidden;">
                            ...
                            <img src="<?php echo ($imglink) ? $imglink : base_url() . "/assets/admin-image/noimage.png" ?>" id="blah" class="img-thumbnail" onclick="addImage()" style="width:300px;cursor: pointer;">
                          </label>
...
<script>
 ...
 ///////////// MEDIA REMOVE CODE ENDS HERE  ///////////////////////////////////////////
  ...
  function pre_view(id)
  {
    ...
    var arr = []
    var checkboxes = document.querySelectorAll('#catagorycheckbox input[type=checkbox]:checked');
    ...
    $.ajax({
      ...
      type:'post',
      data:{id:id,content:source,title:title,seo_url:seo_url,date:date,cat:arr,author:author},
      ...
      success:function(data)
      {
        ...
        window.open('<?php echo base_url(); ?>/preview/' + date + '/' + seo_url + '/' + id, '_blank');  
