                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-4">
                          <button class="btn btn-sm btn-primary btn-block" type="button" id="publish" onclick="publish_post('<?php print_r($id[0]['max_id']);?>')">
                            Publish
                          </button>
   ...
   //console.log('ssss');
    ...
    $.ajax({
      ...
      //  return;
        ...
        window.open('<?php echo base_url();?>/' + date + '/' + seo_url + '/preview' , '_blank');   
    ...
    /////////////////////////////////
     ...
     if(title != '' || source != ''){
      $.ajax({
          ...
          type:'post',
          data:{title:title,seo_url:seo_url,content:source,last_dreaft_id:last_dreaft_id,visibility:visibility,date_:date_,time_:time_,update_date:update_date,nofollow:nofollow,seo_url_no:seo_url_no,post_parent:post_parent,seo_url_text:seo_url_text,image:image,cat:cat_id,keyword_list:keyword_list,meta_tag:meta_tag,meta_desc:meta_desc,date_time:date_time,flag:'1'},
          success:function(data){
            console.log(data);
            draft_working = false;
            if(last_dreaft_id == 0) {
   ...
   // fd.append('file',file);
    ...
    $.ajax({
      ...
      success:function(data){
          ...
          window.location = '<?php echo base_url();?>/admin/posts?st=success';
     }
...
// alert(image);
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        document.getElementById('success').innerText = 'Post saved in draft';
