  ...
  readURL(this);
		...
		<div class="container">
			...
			if(isset($_SESSION['vdata'])){
			 ...
			 ?>
			<form action="<?php echo base_url() ?>admin/static_page/static_page_add_process" method="post" class="newsletter_form1" enctype='multipart/form-data'>
			
			<div class="col-md-8">
		
			<input type="hidden" name="id" id="id" class="newsletter_input"  placeholder="Enter your post title" value="" ><br><br>
			
								<input type="text" name="title" id="title" class="newsletter_input form-control-lg form-control" required  placeholder="Enter your post title" ><br><br>
                <div style="display:none;" id="s_title">	<input type="text" name="sugest_title" id="sugest_title" class="newsletter_input form-control-lg form-control" required  placeholder="Sujested post title"  style="font-size:20px;height:40px;" value="<?php echo isset($_SESSION['post']['sugest_title']) ? $_SESSION['post']['sugest_title']:'' ; ?>"><br><br></div>
							 <div class="col-md-5">
								<input type='file' name='image' id='image' onchange='readURL(this);' style="padding:2px;background:#f2f2f2;" class="newsletter_input form-control-lg form-control"/>
								</div><div class="col-md-3"><img src="" id="blah" style="height:150px;width:200px;display:none"></div><br><br><br><br><br><br><br><br>
								<textarea id="source" name="content" class="newsletter_input1 form-control ckeditor" rows="15" cols="100" required></textarea>
                <br><input type="text" placeholder="Enter Meta tag" name="meta_tag" class="form-control">
                <br><textarea class="form-control" placeholder="Enter Meta description" name="meta_desc"></textarea><br>
								<div id='design'></div>
...
<div class="list-group">
  ...
  <a class="list-group-item">Author<select name="author" class="form-control">
								    <option value="Admin">&nbsp;Admin</option>
								<option value="User">&nbsp;User</option>
								</select></a>
                <a class="list-group-item">Publish
                <input name="date_" type="date" value="<?php echo date("Y-m-d")?>" class="form-control">
                <br><input name="time_" type="time" value="<?php echo date("h:i")?>" class="form-control"></a>
                <a class="list-group-item active"><button class="" style="background:#006699;border:2px solid #006699;color:white;font-size:15px;"><b>&nbsp;Post&nbsp;</b></button>
