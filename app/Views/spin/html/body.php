              ...
              <div class="col-sm-12" style="position: relative;">
                <nav class="tab_filter">
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <!-- <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Sports</button> -->
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="item_card">
                          ...
                          <!-- <a href="" class="item_title">Zhang social media pop also known when smart innocent Zhang social media pop also known when smart innocent</a> -->
                          <!-- <ul class="author_listing no_pad">
                            <li>
                              <div class="author_listing_icon"><i class="fa-solid fa-user"></i></div>
                              <a href="">John Wick</a>
                          ...
                          <!-- <p class="item_para">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius repellat voluptate porro, suscipit excepturi, ab laboriosam voluptatibus nemo quam aliquid facilis tenetur earum, doloremque deleniti dolor placeat quas quibusdam? Ut.</p> -->
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <ul class="thumb_listing">
            ...
            <div class="row mt-50">
              <div class="col-sm-12">
                ...
                <ul class="thumb_listing thumb_medium">
                  <li>
                    <a href="<?php echo $software_post[1]['all_software']['software_url']; ?>" class="thumb_img"><img src="<?php if($software_post[1]['all_software']['software_path'][0]['url']){echo $software_post[0]['all_software']['software_path'][0]['url']; }else{echo $settings[12]['setting_value'];}?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
                    <div class="thumb_content">
        ...
        <div class="row">
                  ...
                  <ul class="ver_post_listing">
                    <li class="ver_post_item">
                      ...
                      <div class="ver_post_info">
                        <a href="<?php echo $travel_post[0]['all_travel']['travel_url']; ?>" class="ver_post_title1"><?php echo $travel_post[0]['all_travel']['post_data']['title']; ?></a>
                        <ul class="author_listing no_pad">
                          <li>
                            <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                    ...
                    <li class="ver_post_item">
                      ...
                      <div class="ver_post_info">
                        <a href="<?php echo $travel_post[1]['all_travel']['travel_url']; ?>" class="ver_post_title1"><?php echo $travel_post[1]['all_travel']['post_data']['title']; ?></a>
                        <ul class="author_listing no_pad">
                          <li>
                            <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                    ...
                    <li class="ver_post_item">
                      <a href="" class="post_cat">Travel</a>
                      <a href="<?php echo $travel_post[2]['all_travel']['travel_url']; ?>" class="var_post_img"><img src="<?php echo $travel_post[2]['all_travel']['travel_path'][0]['url']; ?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
                      <div class="ver_post_info">
                        <a href="<?php echo $travel_post[2]['all_travel']['travel_url']; ?>" class="ver_post_title1"><?php echo $travel_post[2]['all_travel']['post_data']['title']; ?></a>
                        <ul class="author_listing no_pad">
                          <li>
                            <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
                    ...
                    <li class="ver_post_item">
                      ...
                      <div class="ver_post_info">
                        <a href="<?php echo $travel_post[3]['all_travel']['travel_url']; ?>" class="ver_post_title1"><?php echo $travel_post[3]['all_travel']['post_data']['title']; ?></a>
                        <ul class="author_listing no_pad">
                          <li>
                            <div class="author_listing_icon"><i class="fa-solid fa-clock"></i></div>
          ...
          <div class="col-lg-4 col-sm-12">
            ...
            <ul class="thumb_listing review_listing">
              <li>
                <a href="<?php echo $science_post[0]['all_science']['science_url']; ?>" class="thumb_img"><img src="<?php echo $science_post[0]['all_science']['science_path'][0]['url']; ?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
                <div class="thumb_content">
                  <a href="<?php echo $science_post[0]['all_science']['science_url']; ?>" class="thumb_title"><?php echo $science_post[0]['all_science']['post_data']['title']; ?></a>
              ...
              <li>
                <a href="<?php echo $science_post[1]['all_science']['science_url']; ?>" class="thumb_img"><img src="<?php echo $science_post[1]['all_science']['science_path'][0]['url']; ?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
                <div class="thumb_content">
                  <a href="<?php echo $science_post[1]['all_science']['science_url']; ?>" class="thumb_title"><?php echo $science_post[1]['all_science']['post_data']['title']; ?></a>
                  <!-- <div class="review_bar">
                    <span><i class="fa-solid fa-star"></i></span>
                    <span><i class="fa-solid fa-star"></i></span>
                    <span><i class="fa-solid fa-star-half-stroke"></i></span>
            ...
            <li>
              <a href="<?php echo $science_post[2]['all_science']['science_url']; ?>" class="thumb_img"><img src="<?php echo $science_post[2]['all_science']['science_path'][0]['url']; ?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
              <div class="thumb_content">
                <a href="<?php echo $science_post[2]['all_science']['science_url']; ?>" class="thumb_title"><?php echo $science_post[2]['all_science']['post_data']['title']; ?></a>
                <!-- <div class="review_bar">
                  <span><i class="fa-solid fa-star"></i></span>
                  <span><i class="fa-solid fa-star"></i></span>
                  <span><i class="fa-solid fa-star"></i></span>
            ...
            <li>
              <a href="<?php echo $science_post[3]['all_science']['science_url']; ?>" class="thumb_img"><img src="<?php echo $science_post[3]['all_science']['science_path'][0]['url']; ?>" alt="" onerror="myFunction(this)" loading="lazy"></a>
              <div class="thumb_content">
                <a href="<?php echo $science_post[3]['all_science']['science_url']; ?>" class="thumb_title"><?php echo $science_post[3]['all_science']['post_data']['title']; ?></a>
                <!-- <div class="review_bar">
                  <span><i class="fa-solid fa-star"></i></span>
                  <span><i class="fa-solid fa-star"></i></span>
                  <span><i class="fa-solid fa-star-half-stroke"></i></span>
