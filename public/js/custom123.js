...
// let fixsubarea = document.querySelector(".newsletter_area");
// let stickysubs = fixheader.offsetTop = 1400;

// window.addEventListener("scroll", () => {
//     if (window.pageYOffset > stickysubs) {
//         fixsubarea.classList.add("sticky_subarea");
//     } else {
//         fixsubarea.classList.remove("sticky_subarea");
//     }
// });
